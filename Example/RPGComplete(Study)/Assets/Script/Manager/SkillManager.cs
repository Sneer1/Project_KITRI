...
public class SkillManager : MonoSingleton<SkillManager>
{
    ...
    BaseSkill CreateSkill(BaseObject owner, SkillTemplate skillTemplate)
    {
        ...
        {
            case ESkillRangeType.RANGE_BOX:
                {
                ...
                break;
            case ESkillRangeType.RANGE_SPHERE:
                {
    ...
    public void LoadSkillModel()
    {
        ...
        {
            GameObject go = Resources.Load("Prefabs/SkillModel/" + ((ESkillModelType)i).ToString()) as GameObject;
            if(go == null)
            {
